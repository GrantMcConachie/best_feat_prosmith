...
import torch
model_dir = "/projectnb/depaqlab/Grant/ProSmith_scc/downloads"

if model_dir is None:
    print('Model cache directory is not set, manually set a directory in preprocessing.py to avoid hitting home dir quota limit.')
    exit()
else: 
